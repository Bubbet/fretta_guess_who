...
function GM:PlayerSpawn( pl )
    ...
    if pl:Team() == TEAM_SEEKING then
        pl:SetPlayerClass("player_seeker")
    elseif pl:Team() == TEAM_HIDING then
        pl:SetPlayerClass("player_hiding")
    end
...
function GM:OnPlayerChangedTeam( ply, oldteam, newteam )
    ...
    elseif newteam == TEAM_SEEKING then
        ...
        ply:SetPlayerClass("player_seeker")

    elseif newteam == TEAM_HIDING then

        ply:SetPlayerClass("player_hiding")
...
local function PlayerInitialSpawn( pl )
    ...
    if GAMEMODE:GetRoundState() then
        GAMEMODE:SendRoundState( GAMEMODE:GetRoundState(), pl )
    end

end
hook.Add( "PlayerInitialSpawn", "GW_PlayerInitialSpawn", PlayerInitialSpawn )
