...
function GM:UpdateSettings()
    ...
    -- Fretta settings
    self.GameLength				= (self.PreGameDuration + self.RoundDuration + self.HideDuration + self.PostRoundDuration) * self.MaxRounds
    self.AddFragsToTeamScore		= true
    self.CanOnlySpectateOwnTeam 	= true
    self.ValidSpectatorModes 		= { OBS_MODE_CHASE, OBS_MODE_IN_EYE }
    self.Data 					= {}
    self.EnableFreezeCam			= true
    self.NoAutomaticSpawning		= true
    self.NoNonPlayerPlayerDamage	= true
    self.NoPlayerPlayerDamage 	= true
    self.RoundBased				= true
    self.RoundLimit				= self.MaxRounds
    self.RoundLength 				= self.RoundDuration
    self.RoundPreStartTime		= self.PreGameDuration
    self.SuicideString			= "was dead or died mysteriously." -- i think this one is pretty obsolete.
    self.TeamBased 				= true
    self.AutomaticTeamBalance 	= false
    self.ForceJoinBalancedTeams 	= true
